...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True, validate=False,ego_id=0):
        self.params = params
    ...
    def extract_timestamps(yaml_files):
        ...
        for file in yaml_files:
            res = os.path.split(file)[-1]
            #res = file.split('\\')[-1]  windows10
            # res = file.split('/')[-1]  ubuntu
